...
class RummyService(rpyc.Service):
    def exposed_wake(self):
        ...
        output = subprocess.getoutput('python rummy.pyc -wake')
        logger.info(output)
    ...
    def exposed_gather(self, number=None):
        ...
        output = subprocess.getoutput('python rummy.pyc -gather {}'.format(number if number else ''))
        logger.info(output)
        output = json.loads(output)
        return output
    ...
    def exposed_unlock(self):
        ...
        output = subprocess.getoutput('python rummy.pyc -unlock')
        logger.info(output)
        output = json.loads(output)
        return output
    ...
    def exposed_prepare(self):
        ...
        output = subprocess.getoutput('python rummy.pyc -prepare')
        output = json.loads(output)
        logger.info(output)
        return output
    ...
    def exposed_add(self, num_pirates=None):
        ...
        output = subprocess.getoutput('python rummy.pyc -add {}'.format(num_pirates if num_pirates else ''))
        output = json.loads(output)
        logger.info(output)
        return output
    ...
    def exposed_remove(self, *pirate_ids):
        ...
        output = subprocess.getoutput('python rummy.pyc -remove {}'.format(json.dumps(pirate_ids)))
        output = json.loads(output)
        logger.info(output)
        return output
    ...
    def exposed_ship_out(self):
        ...
        output = subprocess.getoutput('python rummy.pyc -shipout')
        output = json.loads(output)
        logger.info(output)
        return output
    ...
    def exposed_clues(self, pirate_id=None):
        ...
        output = subprocess.getoutput('python rummy.pyc -clues {}'.format(pirate_id if pirate_id else ''))
        output = json.loads(output)
        logger.info(output)
        return output
    ...
    def exposed_verify(self, clues):
        ...
        output = subprocess.getoutput('python rummy.pyc -verify {}'.format(json.dumps(clues)))
        output = json.loads(output)
        logger.info(output)
        return output
